...
class NearByCitySelectorModal extends Component {
  constructor (props) {
      super(props);
      this.state = {
      };
...
NearByCitySelectorModal.defaultProps = {

};

NearByCitySelectorModal.propTypes = {

};

export default NearByCitySelectorModal;